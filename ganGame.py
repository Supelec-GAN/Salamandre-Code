...
class GanGame:
    ...
    ##
    def __init__(self, discriminator, learning_set, learning_fun, generator, disc_learning_ratio=1, gen_learning_ratio=1, disc_fake_learning_ratio=0, gen_learning_ratio_alone=0):
    ...
    def discriminatorLearningReal(self):
        ...
        self.discriminator.backprop(real_item, 1)  # expected output = 1 pour le moment
    ...
    def discriminatorLearningVirt(self, fake_image, alone=False):
        ...
        self.discriminator.backprop(fake_image, 0)
    ...
    def generatorLearning(self):
        ...
        disc_error_influence = self.discriminator.backprop(fake_image, fooled, False, True)
        self.generator.backprop(noise, disc_error_influence, self.discriminator.layers_list[0].weights)
